            ...
            <div className="relative z-10 p-6 flex flex-col flex-grow">
                <div className="flex justify-between items-start gap-4 mb-4 font-sans">
                    <div className="min-h-[3.5rem] flex items-start flex-grow">
                        <h3 className={`text-[1.35rem] font-black tracking-tight line-clamp-2 leading-[1.1] ${product.stock === 0 ? 'text-zinc-400' : 'text-zinc-100'}`}>
                            {product.name}
                        </h3>
                    </div>
                    <div className="flex flex-col items-end">
                        <span className={`text-xl font-mono font-bold tracking-tighter ${product.stock === 0 ? 'text-zinc-500' : `bg-clip-text text-transparent bg-gradient-to-r ${themeClasses.priceGradient}`}`}>
