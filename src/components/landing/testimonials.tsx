            ...
            <div className="site-container relative z-10">
                ...
                <div className="text-left mb-8 max-w-2xl">
                    ...
                    <p className="text-zinc-500 text-lg">
                        Lo que dicen quienes ya elevaron su experiencia con nuestros productos
                        premium.
                    </p>
                </div>
                ...
                >
                    {testimonials.map((t, idx) => (
                        <motion.div key={idx} variants={fadeInUp}>
                            <GlassCard glow="bg-primary/5" className="p-8 md:p-10 group">
                                {/* Quote Icon */}
                ...
                >
                    <p className="text-zinc-500 mb-2">
                        Únete a cientos de clientes que confían en nosotros
                    </p>
