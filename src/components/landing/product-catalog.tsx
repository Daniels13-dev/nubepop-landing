                    ...
                    <>
                        {totalResults === 0 && (
                            <div className="text-center py-20 min-h-[40vh]">
                                <h3 className="text-2xl font-semibold text-zinc-300 mb-2 font-black uppercase tracking-tighter">Sin Resultados</h3>
                                <p className="text-zinc-500 text-sm max-w-xs mx-auto mb-8">No encontramos vapers o destilados con esos filtros. Prueba con otro estilo.</p>
                                <Button 
                                    variant="outline" 
