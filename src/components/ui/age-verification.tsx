                        ...
                        <div className="relative flex flex-col items-center text-center">
                            ...
                            <div className="flex w-full flex-col gap-3 sm:flex-row">
                                <Button 
                                    onClick={handleDeny}
                                    variant="outline" 
                                    className="flex-1 rounded-xl border-white/10 hover:bg-white/5 h-12"
                                >
                                    Soy menor de 18
                                </Button>
                                <Button 
                                    onClick={handleVerify}
                                    className="flex-1 rounded-xl bg-gradient-to-r from-[#c049eb] to-[#ea1f78] text-white hover:opacity-90 transition-opacity h-12 shadow-[0_0_20px_rgba(192,73,235,0.3)]"
                                >
                                    Sí, tengo 18+
                                </Button>
                            </div>
