...
const fallbackProducts: Product[] = [
  { id: 1, name: "Purple Haze Extract", type: "Sativa", price: 45.99, images: ["https://images.unsplash.com/photo-1596464716127-f2a82984de30?auto=format&fit=crop&q=80&w=400&h=400", "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&q=80&w=400&h=400"] },
  { id: 2, name: "Northern Lights Pure", type: "Indica", price: 42.99, images: ["https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&q=80&w=400&h=400"] },
  { id: 3, name: "Hybrid Blue Dream", type: "Hybrid", price: 40.99, images: ["https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?auto=format&fit=crop&q=80&w=400&h=400"] },
  { id: 4, name: "Lemon Sour Diesel", type: "Sativa", price: 44.99, images: ["https://images.unsplash.com/photo-1611082294975-6804576cb787?auto=format&fit=crop&q=80&w=400&h=400"] },
  { id: 5, name: "Granddaddy Purple High", type: "Indica", price: 48.99, images: ["https://images.unsplash.com/photo-1580870058867-7448261e474f?auto=format&fit=crop&q=80&w=400&h=400"] },
  { id: 6, name: "OG Kush Distillate", type: "Hybrid", price: 41.99, images: ["https://images.unsplash.com/photo-1628143285623-01309325dbb4?auto=format&fit=crop&q=80&w=400&h=400"] },
  { id: 7, name: "Pineapple Express", type: "Sativa", price: 46.99, images: ["https://images.unsplash.com/photo-1585863581729-195156ee1912?auto=format&fit=crop&q=80&w=400&h=400"] },
  { id: 8, name: "Gelato Dream", type: "Hybrid", price: 43.99, images: ["https://images.unsplash.com/photo-1555513812-70b13bf4bb40?auto=format&fit=crop&q=80&w=400&h=400"] },
  { id: 9, name: "Bubba Kush Heavy", type: "Indica", price: 49.99, images: ["https://images.unsplash.com/photo-1658421882103-0dc2aadb31dc?auto=format&fit=crop&q=80&w=400&h=400"] },
]
...
export default function DestiladosPage() {
    ...
    useEffect(() => {
        const fetchDestilados = async () => {
            try {
                const apiUrl = process.env.NEXT_PUBLIC_GOOGLE_SHEETS_DESTILADOS_URL;
                ...
                const formattedData: Product[] = data.map((item: any, index: number) => {
                    ...
                    let imagesArray = ["https://images.unsplash.com/photo-1596464716127-f2a82984de30?auto=format&fit=crop&q=80&w=400&h=400"];
                ...
                console.error("Error al obtener los destilados de Google Sheets:", error);
                setProducts(fallbackProducts);
            } finally {
                setIsLoading(false);
            }
    ...
    const filteredAndSortedProducts = useMemo(() => {
        ...
        // Filtro por tipo
        if (typeFilter !== "all") {
            const mappedType = typeFilter === "indica" ? "Indica" 
                             : typeFilter === "sativa" ? "Sativa" 
                             : "Hybrid"
        ...
        <main className="container mx-auto px-6">
            ...
            <div className="py-24 pt-32 min-h-screen">
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 border-b border-white/10 pb-6">
                    <div>
                        <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-500 mb-4">
                            Destilados
                        </h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-8 md:mt-0">
                        <div className="relative group w-full sm:w-auto">
                            ...
                            >
                                <option value="all">Todas las Cepas</option>
                    ...
                    <>
                        ...
                        {filteredAndSortedProducts.length === 0 && (
                            <div className="text-center py-20 min-h-[40vh]">
                                ...
                                <p className="text-zinc-500">Intenta probar con otros filtros de cepa o revisa la conexión con Google Sheets.</p>
                                <Button 
                                    variant="outline" 
