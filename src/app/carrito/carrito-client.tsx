...
export default function CarritoClient() {
    const { cartItems, updateQuantity, removeFromCart, clearCart, totalItems, totalPrice } =
        useCart()
                ...
                {cartItems.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <p className="text-zinc-500 mb-8 max-w-md">
                            Parece que aún no has agregado productos a tu carrito. Explora nuestras
                            categorías y encuentra tus favoritos.
                        </p>

                        <div className="flex flex-wrap justify-center gap-4">
                            <Link href="/vapers">
                                <Button className="bg-zinc-800 hover:bg-zinc-700 text-white rounded-xl h-12 px-6">
                                    Ver Vapers
                                </Button>
                            </Link>
                            ...
                            <Link href="/combos">
                                <Button className="bg-[#EA1F78] hover:bg-[#F8499D] text-white rounded-xl h-12 px-6">
                                    Ver Combos
                                </Button>
                            </Link>
                        </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 w-full">
                        ...
                        <div className="flex-1 space-y-6">
                            {cartItems.map((item) => (
                                <div
                                    key={item.id}
                                    className="flex gap-6 p-6 rounded-3xl bg-zinc-900/40 backdrop-blur-xl border border-white/5 items-center"
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center justify-between mt-auto">
                                            <div className="flex flex-row items-center border border-white/10 rounded-xl bg-zinc-900/50">
                                                ...
                                                <span className="w-10 text-center font-medium text-zinc-200">
                                                    {item.quantity}
                                                </span>
                                                <button
                                                    onClick={() => updateQuantity(item.id, 1)}
                        ...
                        <div className="w-full lg:w-[400px]">
                            <div className="p-8 rounded-3xl bg-zinc-900/60 backdrop-blur-2xl border border-white/10 sticky top-32 shadow-[0_0_40px_-15px_rgba(234,31,120,0.1)]">
                                ...
                                <p className="text-xs text-zinc-500 mb-6 leading-relaxed">
                                    Pagarás tu orden después de confirmar los detalles del envío por
                                    WhatsApp. No se requieren tarjetas en el sitio.
                                </p>
                                ...
                                <div className="mt-6 flex flex-col items-center gap-4">
                                    ...
                                    <Link
                                        href="/"
                                        className="text-zinc-500 hover:text-white text-sm hover:underline transition-colors"
                                    >
                                        Continuar comprando
                                    </Link>
                                </div>
